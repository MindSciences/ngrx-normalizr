...
exports.createSchemaSelectors = exports.getResult = exports.getNormalizedEntities = exports.normalized = void 0;
...
function normalized(state, action) {
    ...
    switch (action.type) {
        case normalize_1.NormalizeActionTypes.SET_DATA: {
            ...
            return {
                result: result,
                entities: __assign(__assign({}, state.entities), entities)
            };
        }
        case normalize_1.NormalizeActionTypes.CLEAR_DATA: {
            ...
            return {
                result: [],
                entities: __assign(__assign({}, state.entities), (_a = {}, _a[schemaKey] = {}, _a))
            };
        }
        case normalize_1.NormalizeActionTypes.ADD_DATA: {
            ...
            return {
                ...
                entities: Object.keys(entities_1).reduce(function (p, c) {
                    p[c] = __assign(__assign({}, p[c]), entities_1[c]);
                    return p;
        ...
        case normalize_1.NormalizeActionTypes.ADD_CHILD_DATA: {
            ...
            return {
                ...
                entities: Object.keys(entities_2).reduce(function (p, c) {
                    p[c] = __assign(__assign({}, p[c]), entities_2[c]);
                    return p;
                }, newEntities)
            };
        }
        ...
        case normalize_1.NormalizeActionTypes.REMOVE_CHILD_DATA: {
            ...
            return __assign(__assign({}, state), { entities: newEntities });
        }
        default:
            return state;
    }
...
exports.getNormalizedEntities = (0, store_1.createSelector)(getNormalizedState, function (state) { return state.entities; });
exports.getResult = (0, store_1.createSelector)(getNormalizedState, function (state) { return state.result; });
...
function createEntitiesSelector(schema) {
    return (0, store_1.createSelector)(exports.getNormalizedEntities, createEntitiesProjector(schema));
}
...
function createSingleDenormalizer(schema) {
    ...
    return function (entities, id) {
        ...
        var denormalized = (0, normalizr_1.denormalize)((_a = {}, _a[key] = [id], _a), (_b = {}, _b[key] = [schema], _b), entities);
...
function createMultipleDenormalizer(schema) {
    ...
    return function (entities, ids) {
        ...
        var denormalized = (0, normalizr_1.denormalize)(data, (_c = {}, _c[key] = [schema], _c), entities);
